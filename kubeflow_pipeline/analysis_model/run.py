...
def save_cm(results, num_classes, result_path):
...
def main(args):
    ...
    save_cm(results, args.class_nums, args.result_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', type=str, default='/home/ljj/workspace/result')
