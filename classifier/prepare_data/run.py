...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default="/home/ljj/ws/mlops-bentoml/", help='dataset root path')
    parser.add_argument('--img-size', type=int, default=224, help='resize img size')
